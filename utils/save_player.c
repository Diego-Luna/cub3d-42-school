...
/*   Updated: 2023/02/28 11:40:12 by dluna-lo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void ft_save_info_player(t_state *state, char c, int y, int x)
{
	...
	if (c == 'N')
		state->player.direccion = D_NO;
	else if (c == 'S')
		state->player.direccion = D_SO;
	else if (c == 'E')
		state->player.direccion = D_EA;
	else if (c == 'W')
		state->player.direccion = D_WE;
}
